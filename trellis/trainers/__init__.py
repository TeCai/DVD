...
__attributes = {
    ...
    'DiscreteDiffusionTrainer': 'flow_matching.discrete_diffusion',
    'DiscreteDiffusionCFGTrainer': 'flow_matching.discrete_diffusion',
    'TextConditionedDiscreteDiffusionCFGTrainer': 'flow_matching.discrete_diffusion',
    'ImageConditionedDiscreteDiffusionCFGTrainer': 'flow_matching.discrete_diffusion',
...
if __name__ == '__main__':
    ...
    from .flow_matching.discrete_diffusion import (
        DiscreteDiffusionTrainer,
        DiscreteDiffusionCFGTrainer,
        TextConditionedDiscreteDiffusionCFGTrainer,
        ImageConditionedDiscreteDiffusionCFGTrainer,
    )
